...
const PERMISSIONS = [
  ...
  // phase 17 — offline sync (docs/phase_17.md)
  { key: "sync.use", module: "sync", description: "Register devices & replay the offline queue (field connectivity)" },
  { key: "sync.manage", module: "sync", description: "View all sync logs/conflicts & offline adoption analytics" },
...
const GRANTS = {
  consumer: ["profile.self", "trace.resolve", "documents.view", "sync.use"],
  farmer: ["profile.self", "trace.resolve", "identification.detect", "batch.create", "batch.view", "batch.transfer", "documents.upload", "documents.view", "documents.share", "analytics.view", "reports.generate", "sync.use"],
  transporter: ["profile.self", "trace.resolve", "batch.view", "batch.transfer", "shipment.manage", "shipment.assign", "documents.upload", "documents.view", "sync.use"],
  lab: ["profile.self", "trace.resolve", "batch.view", "batch.request", "batch.receive", "lab.test", "lab.certify", "lab.reject", "procurement.approve", "blockchain.view", "documents.upload", "documents.view", "documents.share", "analytics.view", "reports.generate", "sync.use"],
  manufacturer: ["profile.self", "trace.resolve", "batch.view", "batch.request", "batch.receive", "product.create", "product.link", "product.qr", "shipment.manage", "procurement.view", "procurement.request", "procurement.receive", "procurement.inventory", "verify.analytics.view", "blockchain.view", "documents.upload", "documents.view", "documents.share", "analytics.view", "reports.generate", "sync.use"],
  distributor: ["profile.self", "trace.resolve", "product.create", "product.link", "product.qr", "product.sell", "shipment.manage", "documents.upload", "documents.view", "sync.use"],
  retailer: ["profile.self", "trace.resolve", "product.sell", "shipment.manage", "documents.upload", "documents.view", "sync.use"],
  admin: ["admin.users.manage", "admin.users.view", "admin.audit.view", "admin.trace.view", "admin.analytics.view", "verify.analytics.view", "blockchain.view", "blockchain.manage", "labs.audit", "manufacturers.audit", "shipments.view", "certificates.review", "compliance.manage", "reports.export", "reports.generate", "admin.search", "notifications.view", "notifications.manage", "documents.upload", "documents.view", "documents.share", "documents.manage", "analytics.view", "analytics.manage", "sync.use", "sync.manage"],
};
