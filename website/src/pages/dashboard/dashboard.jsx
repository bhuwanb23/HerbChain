    ...
    <ThemeProvider theme={theme}>
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        <Routes>
          ...
          <Route path="/compliance" element={<div className="py-10 text-center"><h1 className="text-2xl font-semibold">Compliance & Regulation</h1><p className="text-gray-500 mt-2">Temporarily unavailable.</p></div>} />
