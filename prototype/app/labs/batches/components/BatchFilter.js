...
const BatchFilter = ({ activeBatchFilter, setActiveBatchFilter, activeHerbFilter, setActiveHerbFilter, activeLocationFilter, setActiveLocationFilter, activeStatusFilter, setActiveStatusFilter }) => {
  return (
