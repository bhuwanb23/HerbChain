    ...
    <SafeAreaWrapper style={styles.container} includeBottom={true}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Manage your transportation tasks</Text>
        </View>
        ...
        <View style={styles.content}>
          <View style={styles.card}>
            ...
            <Text style={styles.cardSubtitle}>3 deliveries in progress</Text>
          </View>

          <View style={styles.card}>
            <Text style={styles.cardIcon}>📦</Text>
            <Text style={styles.cardTitle}>Packages</Text>
            <Text style={styles.cardSubtitle}>12 packages to deliver</Text>
          </View>

          <View style={styles.card}>
            <Text style={styles.cardIcon}>📍</Text>
            <Text style={styles.cardTitle}>Routes</Text>
            <Text style={styles.cardSubtitle}>5 optimized routes</Text>
          </View>

          <View style={styles.card}>
            <Text style={styles.cardIcon}>💰</Text>
            <Text style={styles.cardTitle}>Earnings</Text>
            <Text style={styles.cardSubtitle}>₹15,400 this month</Text>
          </View>
        </View>
